...
public class AppTest {
    ...
    public static final String APP_LOC = "src/resources";
    public final static String PLATFORM_NAME = "Android";
    public final static String DEVICE_NAME = "CB5A26694T"; // Change Device Name
    public final static File file = new File(APP_LOC);
    public final static String APP_PATH = file.getAbsolutePath() + "/" + APP_NAME;
